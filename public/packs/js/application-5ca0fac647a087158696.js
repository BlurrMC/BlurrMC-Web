...
var map = {
	"./searchresults_channel.js": "./app/javascript/channels/searchresults_channel.js"
};
...
/***/ "./app/javascript/channels/searchresults_channel.js":
/*!**********************************************************!*\
  !*** ./app/javascript/channels/searchresults_channel.js ***!
  \**********************************************************/
/*! no exports provided */
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("SearchresultsChannel", {
...
__webpack_require__(/*! packs/dropdown */ "./app/javascript/packs/dropdown.js");

__webpack_require__(/*! packs/users */ "./app/javascript/packs/users.js");

__webpack_require__(/*! packs/popup_video */ "./app/javascript/packs/popup_video.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/***/ "./app/javascript/packs/popup_video.js":
/*!*********************************************!*\
  !*** ./app/javascript/packs/popup_video.js ***!
  \*********************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {$(document).on("click", ".element", function () {
  var video = $(this).attr("video"); // pass video variable through button

  $('.di').html("<%= j render partial: \"/partials/videos/window\", video: ".concat(video, " %>"));
});
document.getElementById('di').classList.add("bg-ha"); // add bg-ha to stylesheet, di is the id of the div that shows up

var isItOpen = false;

function muffinMan() {
  if (isItOpen != true) {
    document.getElementById('damn').classList.add("blurr"); // Everything other than the di must be inside this damn div, add blurr to stylesheet

    document.getElementById('di').classList.add("bg-sad"); // Shows di

    isItOpen = true;
  } else {
    document.getElementById('damn').classList.remove("blurr");
    document.getElementById('di').classList.remove("bg-sad");
    document.getElementById('di').classList.add("bg-ha");
    isItOpen = false;
  }
}
...
/******/ });
//# sourceMappingURL=application-5ca0fac647a087158696.js.map