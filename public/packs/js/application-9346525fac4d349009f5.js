...
/* WEBPACK VAR INJECTION */(function($) {di = document.getElementById('di');
damn = document.getElementById('damn');
di.classList.add("bg-ha"); // add bg-ha to stylesheet, di is the id of the div that shows up

var isItOpen = false;

function muffinMan(id) {
  di.empty(); // Empty everything inside :)

  if (isItOpen != true) {
    $('.di').html("<%= j render partial: \"/partials/videos/window\", passed_video_id: ".concat(id, " %>"));
    damn.classList.add("blurr"); // Everything other than the di must be inside this damn div, add blurr to stylesheet

    di.classList.add("bg-sad"); // Shows di
...
/******/ });
//# sourceMappingURL=application-9346525fac4d349009f5.js.map