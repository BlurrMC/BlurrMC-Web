...
ActiveRecord::Schema.define(version: 2021_06_10_174904) do
  ...
  create_table "cs", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id", null: false
    t.index ["user_id"], name: "index_cs_on_user_id"
  end
  ...
  create_table "notifications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["recipient_id", "actor_id", "action", "notifiable_id", "notifiable_type"], name: "unique_notification_index", unique: true
  end
  ...
  create_table "reports", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["actor_id", "reportable_id", "reportable_type"], name: "index_reports_on_actor_id_and_reportable_id_and_reportable_type", unique: true
    t.index ["actor_id"], name: "index_reports_on_actor_id"
  end
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "follownotifications", default: true
    t.boolean "commentnotifications", default: true
    t.boolean "likecommentnotification", default: true
    t.boolean "replynotifications", default: true
    t.boolean "likedvideonotifications", default: true
  ...
  create_table "video_hash_tags", force: :cascade do |t|
    t.bigint "video_id"
